...
from stages.onnxparser import (
    ONNXModelParserStageNoMapping as StreamONNXModelParserStageNoMapping,
)
...
def optimize_single_hardware_co(  # noqa: PLR0913
    ...
    tiling_configuration_optimization_method: str = "manual",
    tiling_config_ga_generations: int = 6,
    tiling_config_ga_population: int = 24,
    tiling_config_ga_seed: int = 42,
    max_tiles_per_node: int = 10_000,
    ...
    if os.path.exists(scme_path) and skip_if_exists:
        ...
        mainstage = MainStage(
            ...
            tiling_configuration_optimization_method=tiling_configuration_optimization_method,
            tiling_config_ga_generations=tiling_config_ga_generations,
            tiling_config_ga_population=tiling_config_ga_population,
            tiling_config_ga_seed=tiling_config_ga_seed,
            max_tiles_per_node=max_tiles_per_node,
        )
